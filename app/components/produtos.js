    ...
    <div className="flex flex-wrap justify-center gap-10 mt-8">
      ...
      <div className='flex flex-wrap justify-between w-[75%] h-auto'>
        ...
        {items.produtos_em_promocoes.map(item_especial => (
          <div key={item_especial.id} className="flex text-[#FFF] mt-10 font-protest-guerrila shadow-md shadow-black relative justify-center rounded-3xl hover:shadow-white duration-300 ease-in h-[300px] w-[15rem]">
            <button className='flex justify-center'>
