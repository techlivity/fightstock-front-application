    ...
    <div className="flex flex-wrap justify-center gap-10 mt-8">
      ...
      <div className='flex flex-wrap justify-between w-[75%] h-auto'>
        <div className='flex w-full justify-center'>
          <h1 className='font-climate flex text-2xl text-zinc-50 drop-shadow-lg'>Produtos em Destaque</h1>
        </div>
      ...
      <div className='flex flex-wrap justify-evenly mb-5 w-[80%] h-auto'>
        <div className='flex w-full justify-center'>
          <h1 className='font-climate flex text-2xl text-zinc-50 drop-shadow-lg'>Promoções Especiais</h1>
        </div>

        <div className="flex text-[#FFFFFF] mt-10 font-gabarito relative justify-center rounded-3xl h-[450px] w-[40%]">
          <button className='flex justify-center'>
