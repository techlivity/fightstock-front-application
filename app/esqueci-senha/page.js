...
export default function Page() {
  ...
  return (
    <div className="relative w-screen h-screen flex flex-row items-center text-white">
        <div id='form' className="absolute z-10 w-[60vh] h-[50vh] hover:h-[100vh] overflow-hidden duration-700 rounded-xl hover:rounded-none bg-[#300d0b] shadow-[#1a0f0e] shadow-md">
            <div className='h-[100%] flex justify-center items-center'>
                <div className="flex flex-col w-[90%] items-center">
                    ...
                    <button className='flex mt-8 items-center w-[4rem] bg-[#1d942d] hover:bg-[#17421d] hover:w-[24%] duration-200 ease-in py-2 rounded-xl overflow-hidden'>
        ...
        <div>
            <Image id="bgContainer" className='duration-1000' src={bgSenha} sizes="100vw 100vh" fill></Image>
        </div>
    </div>
  )
}
