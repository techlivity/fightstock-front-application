                ...
                <div className="flex flex-col w-[90%] items-center">
                    ...
                    <form className="w-full space-y-2 flex flex-col" action="/processar-cadastro" method="post">
                        <div className='flex flex-row items-center space-x-2'>
                            ...
                            <label className="font-oswald text-xl w-full" htmlFor="login">Email Cadastrado:</label>
                        </div>
                        <input
                        ...
                        <div className='flex flex-row items-center space-x-2'>
                            ...
                            <label className="font-oswald text-xl w-full" htmlFor="senha">Nova Senha:</label>
                        </div>
                        <input
                            className="rounded-md font-oswald px-4 py-1 w-[100%] text-slate-900 outline-none"
                            type="password"
                        ...
                        <div className='flex justify-center'>
                            <button type='submit' className='flex mt-2 items-center w-[4rem] bg-[#1d942d] hover:bg-[#17421d] hover:w-[24%] duration-200 ease-in py-2 rounded-xl overflow-hidden'>
                                <span className="ml-[0.9rem] font-oswald text-lg">Salvar</span>
                                <CheckIcon className="relative left-2 h-6 w-6 text-[#FFFFFF]" />
                            </button>
                        </div>
                    </form>
                    <div className="flex flex-row mt-5">
                        <Link prefetch={true} className="flex flex-row font-oswald items-center text-xl cursor-pointer hover:text-green-800 duration-200 ease-in" href="/criar-conta">
                            <UserPlusIcon className="h-6 w-6 mr-1" />
                            <span>Cadastre-se</span>
                        </Link>
                        <span className="px-4">/</span>
                        <Link prefetch={true} className="flex flex-row font-oswald items-center text-xl hover:text-green-800 duration-200 ease-in" href="/login">
