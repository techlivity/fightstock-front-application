    ...
    <main>
      ...
      <Carousel_Component items={data.carrossel}></Carousel_Component>
        <div className='flex flex-wrap justify-between w-[75%] h-auto m-auto'>
            ...
            <div key={item_especial.id} className="flex text-[#FFFFFF] mt-10 font-protest-guerrila relative justify-center rounded-3xl hover:shadow-lg hover:shadow-white duration-300 ease-in h-[300px] w-[15rem]">
