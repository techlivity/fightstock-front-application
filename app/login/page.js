                ...
                <div className="flex flex-col w-[90%] items-center">
                    ...
                    <form className="w-full space-y-2 flex flex-col" action="/processar-cadastro" method="post">
                        <div className='flex flex-row items-center space-x-2'>
                            ...
                            <label className="font-gabarito text-xl w-full" htmlFor="login">Login:</label>
                        </div>
                        <input
                        ...
                        <div className='flex flex-row items-center space-x-2'>
                            ...
                            <label className="font-gabarito text-xl w-full" htmlFor="senha">Senha:</label>
                        </div>
                        <input
                            className="rounded-md px-4 py-1 w-[100%] outline-none"
                            type="password"
                        ...
                        <div className='flex justify-center'>    
                            <button type='submit' className='flex mt-2 items-center w-[4rem] bg-[#1d942d] hover:bg-[#17421d] hover:w-[26%] duration-200 ease-in py-2 rounded-xl overflow-hidden'>
                                <span className="ml-3 font-gabarito">Entrar</span>
                                <ArrowRightEndOnRectangleIcon className="relative left-4 h-7 w-7 text-[#FFFFFF]" />
                            </button>
                        </div>
                    </form>
                    <div className="flex flex-row mt-5">
                        <Link prefetch={true} className="flex flex-row font-gabarito text-xl items-center cursor-pointer hover:text-green-800 duration-200 ease-in" href="/criar-conta">
                            <UserPlusIcon className="h-6 w-6 mr-1" />
                            <span>Cadastre-se</span>
                        </Link>
                        <span className="px-4">/</span>
                        <Link prefetch={true} className="flex flex-row font-gabarito text-xl items-center hover:text-red-900 duration-200 ease-in" href="/esqueci-senha">
