            ...
            <div className="w-screen h-screen flex items-center text-white">
                <div className="w-[60vh] h-[50vh] rounded-xl m-auto bg-[#300d0b] flex justify-center items-center shadow-[#1a0f0e] shadow-md">
                    <div className="flex flex-col w-[90%] items-center">
                        ...
                        <button className="font-protest-guerrila mt-8 bg-[#1d942d] hover:bg-[#17421d] duration-200 ease-in py-2 rounded-xl w-[25%]">Criar Conta</button>
                        <div className="mt-5">
                            <a className="font-protest-guerrila text-lg cursor-pointer hover:text-green-800 duration-200 ease-in" type="submit" href="/login">Já cadastrado? Acesse!</a>
                            <span className="px-2">/</span>
                            <a className="font-protest-guerrila text-lg hover:text-red-900 duration-200 ease-in" href="/esqueci-senha">Esqueci minha senha</a>
                        </div>
